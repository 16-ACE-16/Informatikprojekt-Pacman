...
########################### INTRO FUNCTIONS ####################################
    ...
    def start_draw(self):
        ...
        self.draw_text('Leertaste drücken', self.screen, [
                       WIDTH//2, HEIGHT//2-50], Schriftgroeße, (170, 132, 58), Schrift, centered=True) #Mit Schriftarten verbinden
        self.draw_text('1 Spieler', self.screen, [
                       WIDTH//2, HEIGHT//2+50], Schriftgroeße, (44, 167, 198), Schrift, centered=True)
...
########################### PLAYING FUNCTIONS ##################################
    ...
    def playing_draw(self):
        ...
        self.draw_text('HIGH SCORE: 0', self.screen, [WIDTH//2+60, 0], 18, WHITE, Schrift)
        self.player.draw()
        for enemy in self.enemies:
            enemy.draw()
        pygame.display.update()
...
########################### GAME OVER FUNCTIONS ################################
    ...
    def game_over_draw(self):
        ...
        self.draw_text("Gameover", self.screen, [WIDTH//2, 100],  52, RED, "Zusatz/Oswald-Bold.ttf", centered=True)
        self.draw_text(again_text, self.screen, [
                       WIDTH//2, HEIGHT//2],  36, (190, 190, 190), "ZUsatz/Oswald-Bold.ttf", centered=True)
